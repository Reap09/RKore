...
public class Licensing {
	...
	public boolean register() {
		log(0, "[&dRKore licensing&r] Connecting to License-Server");
		ValidationType vt = isValid();
		if (vt == ValidationType.VALID) {
			log(1, "[&dRKore licensing&r] License Valid!");
			return true;
		} else {
			log(1, "[&dRKore licensing&r] License is NOT valid!");
			log(1, "[&dRKore licensing&r] Failed as a result of " + vt.toString());
			log(1, "[&dRKore licensing&r] Disabling plugin...");
