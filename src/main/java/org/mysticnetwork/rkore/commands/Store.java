...
public class Store extends SimpleCommand {
    ...
    public Store(SimpleCommandGroup parent) {
        ...
        setPermissionMessage(Settings.InfoCommands.STORE_NO_PERMISSION.replace("{prefix}", Settings.PREFIX));
    ...
    protected void onCommand() {
        if (sender instanceof Player) {
            ...
            sender.sendMessage((Settings.InfoCommands.STORE_MESSAGE).replace("{prefix}", Settings.PREFIX));
        }
    }
}